...
import { searchFuzzy } from "../../src/utils/hangul.js";
    ...
    const mockData = [
        {
            nameKo: "피카츄",
            nameEn: "pikachu",
            searchKey: "피카츄|pikachu|ㅍㅣㅋㅏㅊㅠ|ㅍㅋㅊ",
            d: "ㅍㅣㅋㅏㅊㅠ",
            c: "ㅍㅋㅊ",
        },
        {
            nameKo: "라이츄",
            nameEn: "raichu",
            searchKey: "라이츄|raichu|ㄹㅏㅇㅣㅊㅠ|ㄹㅇㅊ",
            d: "ㄹㅏㅇㅣㅊㅠ",
            c: "ㄹㅇㅊ",
        },
        {
            nameKo: "파이리",
            nameEn: "charmander",
            searchKey: "파이리|charmander|ㅍㅏㅇㅣㄹㅣ|ㅍㅇㄹ",
            d: "ㅍㅏㅇㅣㄹㅣ",
            c: "ㅍㅇㄹ",
        },
        {
            nameKo: "꼬부기",
            nameEn: "squirtle",
            searchKey: "꼬부기|squirtle|ㄲㅗㅂㅜㄱㅣ|ㄲㅂㄱ",
            d: "ㄲㅗㅂㅜㄱㅣ",
            c: "ㄲㅂㄱ",
        },
    ];
