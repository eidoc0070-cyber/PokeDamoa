import { describe, expect, it } from "bun:test"; // vitest -> bun:test
import { getTypeMatchupsForGen, getTypesForGenList } from "../../src/data/constants.js";
import { getAbilitiesForGen, getStatsForGen, getTypesForGen } from "../../src/utils/pokemon-math.js";
...
describe("Generation Logic Tests", () => {
    ...
    describe("Pokemon Data Versioning Utilities", () => {
        const mockPokemon = {
            ...
            abilitiesPast: [{ genId: 3, abilities: [{ id: 2, isHidden: false }] }],
        };
