                    ...
                    <div class="party-members" style="display:grid; grid-template-columns: repeat(3, 1fr); gap:8px; padding:10px;">
                        ${p.members
                            .map((m, idx) => {
                                ...
                                if (!poke)
                                    return `<div style="height:60px; background:#f9f9f9; border-radius:8px; border:1px dashed #ddd; display:flex; align-items:center; justify-content:center; color:#ccc; font-size:0.7rem;">비어있음</div>`;
                                return `
